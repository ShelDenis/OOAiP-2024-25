...
public class RotateCommandTests
{
    ...
    public void CantReadAngleTest()
    {
        ...
        mockRotating.SetupGet(x => x.VelocityAngle).Returns(new Angle(30));
        var command = new RotateCommand(mockRotating.Object);
    ...
    {
        var mockRotating = new Mock<IRotate>();
        mockRotating.SetupGet(x => x.PositionAngle).Returns(new Angle(30));
    ...
    public void CantChangeAngleTest()
    {
        ...
        mockRotating.SetupGet(x => x.VelocityAngle).Returns(new Angle(655));
        var command = new RotateCommand(mockRotating.Object);
        Assert.Throws<Exception>(() => command.Execute());
    }
}
